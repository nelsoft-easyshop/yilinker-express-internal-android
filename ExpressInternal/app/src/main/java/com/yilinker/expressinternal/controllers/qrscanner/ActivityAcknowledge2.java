...
/**
 * Created by J.Bautists on 3/10/16.
 */
public class ActivityAcknowledge2 extends BaseActivity implements QRCodeReaderView.OnQRCodeReadListener, ResponseHandler {
    ...
    private void goToDetails(JobOrder jobOrder){
        ...
        Intent intent = new Intent(ActivityAcknowledge2.this, ActivityJobDetailsMain.class);
