 ...
 */
public class ActivityChecklist2 extends BaseActivity implements RecyclerViewClickListener<ChecklistItem>, ResponseHandler, DialogDismissListener {
...
//    private String recipientPicture;
    ...
    private com.yilinker.expressinternal.mvp.model.Package selectedPackage;
...
//        layoutManager.setOrientation(LinearLayoutManager.VERTICAL);
    ...
    private void showSignature() {
        ...
        Intent intent = new Intent(ActivityChecklist2.this, ActivitySignature.class);
    ...
    private void showPackageConfirmation() {
        ...
        if(selectedPackage == null){
            ...
            selectedPackage.setJobOrderNo(jobOrder.getJobOrderNo());
        }

        Intent intent = new Intent(ActivityChecklist2.this, ActivityConfirmPackage.class);
...
//    }
    ...
    private void goToCompleteScreen() {
        ...
        Intent intent = new Intent(ActivityChecklist2.this, ActivityComplete2.class);
        intent.putExtra(ActivityComplete.ARG_JOB_ORDER, jobOrder);
        intent.putExtra(ActivityComplete.ARG_FROM_HOME, false);
        startActivity(intent);
    }
...
//    }
    ...
    private void goToHome() {
        ...
        Intent intent = new Intent(ActivityChecklist2.this, ActivityMain.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(intent);
    }
    ...
    private void handleConfirmPackage(Intent data) {
        ...
        selectedPackage = data.getParcelableExtra(ActivityConfirmPackage.ARG_SELECTED_PACKAGE);
    ...
    private void showImageGallery(ArrayList<String> images, int requestCode) {
        ...
        Intent intent = new Intent(ActivityChecklist2.this, ActivityImageGallery.class);
